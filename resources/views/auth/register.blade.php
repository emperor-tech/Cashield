<x-guest-layout>
    <div class="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mt-12">
        <h1 class="text-2xl font-bold mb-6 text-blue-900 dark:text-blue-200">Create Account</h1>
