...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full" x-data="{ dark: localStorage.getItem('darkMode') === 'true' }" x-bind:class="{ 'dark': dark }">
    ...
    <body class="font-sans antialiased h-full">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            ...
            <!-- Dark Mode Toggle -->
            <div class="mt-4">
                <button @click="dark = !dark" class="p-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
